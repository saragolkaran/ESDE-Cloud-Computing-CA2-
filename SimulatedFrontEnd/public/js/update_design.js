...
let blackList = /^.+|\s+<[a-z0-9!@#$%^&*()_+\/?"'=\s]+>.+<[a-z0-9!@#$%^&*()_+\/?"'=\s]+>.+|\s$/i
if ($updateDesignFormContainer.length != 0) {
    ...
    $('#submitButton').on('click', function (event) {
        ...
        // if (blackList.test(designTitle) || blackList.test(designTitle)){
        //     window.alert("Update unsuccessful! Please input a valid string!")
        //     return
        // }
    ...
    function getOneData() {
        ...
        axios({
            ...
            .then(function (response) {
                ...
                const record = response.data.data.filedata;
